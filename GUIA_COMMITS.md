...
4. Ejecuten: `git init`
5. Vayan ejecutando **solo los comandos exactos** que aparecen en los recuadros grises a continuación, en el orden estricto del 1 al 26.
...
## Secuencia Exacta de Commits (26 Commits)
...
**25. Frontend: Dashboard y Settings** (Felipe)
```bash
...
git commit --author="Felipe <felipe@correo.com>" -m "feat(front): implementacion del dashboard principal y validacion de documentos"
```

**26. Commit Final: Resto de archivos sueltos** (Milton)
...
1. Una vez ejecutados todos estos comandos en orden, verifiquen su historial escribiendo:
   ...
   git log --oneline
   ```
2. Deberán ver los 26 commits listados con los nombres de **David, Milton y Felipe**.
